 ...
 *
 */
public class WeatherDataAggregationException extends Exception {

	private static final long serialVersionUID = -6747826972714459171L;

	public WeatherDataAggregationException(String msg)
	{
		super(msg);
	}
}
