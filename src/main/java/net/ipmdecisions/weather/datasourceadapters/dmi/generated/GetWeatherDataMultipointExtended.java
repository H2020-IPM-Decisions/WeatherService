...
@XmlRootElement(name = "GetWeatherDataMultipointExtended", namespace = "http://tempuri.org/")
public class GetWeatherDataMultipointExtended {

    @XmlElementRef(name = "xCoordinate", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> xCoordinate;
    @XmlElementRef(name = "yCoordinate", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    ...
    @XmlElement(namespace = "http://tempuri.org/")
    protected Boolean getExtendedEndDate;
    ...
    /**
     * Gets the value of the getExtendedEndDate property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isGetExtendedEndDate() {
        return getExtendedEndDate;
    }

    /**
     * Sets the value of the getExtendedEndDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setGetExtendedEndDate(Boolean value) {
        this.getExtendedEndDate = value;
    }
