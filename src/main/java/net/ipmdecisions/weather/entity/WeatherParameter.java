 ...
 * IPM Decisions platform. Complete list: https://platform.ipmdecisions.net/weather/rest/parameter/list
 * 
...
public class WeatherParameter {
     ...
     */
    @Schema(examples = "Mean air temperature at 2m")
     ...
     */
    @Schema(examples = "Long and thorough description of the parameter goes here.")
